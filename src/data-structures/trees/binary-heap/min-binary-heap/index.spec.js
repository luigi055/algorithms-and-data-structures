...
describe("Testing MinBinaryHeap Class", () => {
  ...
  describe("Insertion", () => {
    ...
    it("should create a correct MinBinaryHeap", () => {
      ...
      expect(minBinaryHeap.values).toEqual([1,5,4,9,12,8,6,25,19,100,15,17,11,36,13])
  ...
  describe("extractMax method", () => {
    ...
    it("should extract successfully a big MinBinaryHeap", () => {
      ...
      expect(minBinaryHeap.values).toEqual([4,5,6,9,12,8,13, 25,19,100,15,17,11,36])
    })
    it("should extract successfully 3 min values in a MinBinaryHeap", () => {
      ...
      expect(minBinaryHeap.values).toEqual([6,9,8,19,12,11,13,25,36,100,15,17])
    })
  })
})